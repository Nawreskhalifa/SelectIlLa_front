<template>
  <div class="products-sidebar-filter bg-white letter-spacing mb-25">
    ...
    <div class="sidebar-item">
      ...
      >
        <li
          @click="byCategory('All'), toggleCategorySelection()"
          class="cat"
          :class="{ selected: all }"
        >
...
export default {
  ...
  computed: {
    allVehiclesByBrand() {
      if (!this.selectedMake || !this.selectedMake.attributes?.vehicles?.data)
        return 0;
