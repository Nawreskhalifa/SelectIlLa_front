...
export default {
  ...
  data() {
    return {
      categories: [],
      name: this.villa.attributes.name,
      city: this.villa.attributes.city,
      rooms: this.villa.attributes.rooms,
      baths: this.villa.attributes.baths,
      pool: this.villa.attributes.pool,
      view: this.villa.attributes.view,
      sleeps: this.villa.attributes.sleeps,
      daily: this.villa.attributes.daily,
      newDaily: this.villa.attributes.new_daily,
