...
export default defineComponent({
  ...
  async mounted() {
    ...
    if (this.$route.params && this.$route.params.id) {
      this.isLoading = true;
      const {data} = await fetchPartnersById(this.$route.params.id);
      this.partner = data
       this.address = this.partner.attributes.address;
      this.name = this.partner?.attributes.name;
      this.surname = this.partner?.attributes.surname;
      this.datofbirth =
      ...
      this.databasePhoto.push({
        ...
        url:
          this.uploadUrl +
          this.partner?.attributes.user.data?.attributes.photo?.data
            ?.attributes.url,
      });
      this.selectedPhoto.push({
        id: this.partner?.attributes.user.data?.attributes.photo?.data?.id,
      ...
      this.password = "";
      this.email = this.partner?.attributes.user.data?.attributes.email;
      this.ancienEmail =
        this.partner?.attributes.user.data?.attributes.email;
      this.idUser = this.partner?.attributes.user.data?.id;
